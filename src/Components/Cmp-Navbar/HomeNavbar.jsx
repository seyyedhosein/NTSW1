...
const HomeNavbar = () => {
    ...
    return (
            ...
            <div className="justify maincontainer "   >
                <ul className="nav nav-pills  navbar2 d-flex flex-row-reverse  justify-content-around w-50 align-items-center ">
                    ...
                    <Dropdown isOpen={dropdownOpen} onMouseEnter={toggle} onMouseLeave={toggle} >
                        <DropdownToggle caret className="d-flex  border-0 navhover justify-content-center align-items-center" id="dropdown-basic">
                            ثبت نام
                            {/* <p id="p1" ></p> */}
